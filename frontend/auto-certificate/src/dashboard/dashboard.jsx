...
async function dataProgres() {
  const res = await fetch("https://quran-monitoring-cq7u.vercel.app/auth/login/getProgres", {
    method: "POST",
...
const handleLogout = async () => {
  try {
    const res = await fetch("https://quran-monitoring-cq7u.vercel.app/auth/logout", {
      method: "POST",
...
function LogbookPage() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://quran-monitoring-cq7u.vercel.app/auth/login/receiveData", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
